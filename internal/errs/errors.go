...
var (
	...
	ErrInvalidCharacterHPDelta   = errors.New("無効なHPの増加量です")
	ErrInvalidCharacterATKDelta  = errors.New("無効なATKの増加量です")
	ErrInvalidCharacterTECHDelta = errors.New("無効なTECHの増加量です")
	ErrCharacterAlreadyMaxLevel  = errors.New("既に最大レベルです")
	ErrInvalidCharacterLevel     = errors.New("不正なレベルです")
